...
function submitPerson ( $data ) {
	...
	$endpoint = 'https://docs.google.com/forms/d/e/'
			. '1FAIpQLSeyzNZ7laJxLUjPJOY4gYFuimmb6ASDgzJL1Np1mIio6w860A/formResponse';
	$requestBody = [
		...
		'entry.1678371935' => $data[ 'extendedAttributes' ]
	];
...
function submitPersonActivity ( $data ) {
	...
	$endpoint = 'https://docs.google.com/forms/d/e/'
			. '1FAIpQLSfcT7Ra0L7DsBpgcxa-nNq4S05NKkB0U6-n86EAnezFkiAHPQ/formResponse';
	$requestBody = [
		'entry.555951609' => $data[ 'when' ],
		'entry.1270704247' => $data[ 'activity' ],
		...
		'entry.614407814' => $data[ 'activityData' ]
